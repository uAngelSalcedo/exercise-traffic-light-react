...
+  Crea un botón que, al hacer clic en él, alterna el color seleccionado del semáforo entre rojo, verde y amarillo.
+  Tener un botón que al hacer clic en él, añada un color extra "púrpura" al semáforo.
